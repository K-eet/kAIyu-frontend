...
.waves-container {
  ...
  height: 150px;
  overflow: hidden;
  /* --- NEW: This creates the blending effect at the bottom of the waves --- */
  /* It makes the bottom ~30% of the waves fade from opaque to transparent */
...
@media (max-width: 768px) {
  ...
  .wave-footer {
    position: relative;
    width: 100%;
    background: linear-gradient(to bottom, #603913, #d08e62);
    color: white;
    overflow: hidden;
    padding-top: 150px;
  }
