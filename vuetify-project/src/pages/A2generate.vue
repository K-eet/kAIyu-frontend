    ...
    <v-row class="fill-height" justify="center">
      ...
      <v-col cols="12" md="6" lg="5" xl="4" class="d-flex">
        <!-- <v-card class="pa-4 flex-grow-1"> -->
          <v-card class="upload-card h-100 flex-grow-1 pa-4 bg-white"
                  elevation="0"
                  variant="outlined"
                  rounded="xl"
                  >
          ...
          <v-card-text>
            ...
            <v-card v-else class="uploaded-image-card pa-4 mb-4" rounded border>
                ...
                <v-btn color="##E56F2C" variant="outlined" @click="removeImage" class="mr-2">
                Remove Image
                </v-btn>
      ...
      <v-col cols="12" md="6" lg="5" xl="4" class="d-flex">
        <!-- <v-card class="pa-4 flex-grow-1"> -->
        <v-card class="config-card h-100 flex-grow-1 pa-4 bg-white"
                  elevation="0"
                  variant="outlined"
                  rounded="xl"
          >
          ...
          <v-btn
            ...
            @click="startLoadingAndRedirect" class="cursor-pointer image-container"
          >
            Generate Design
          </v-btn>
...
const roomTypes = ['Living Room', 'Bedroom', 'Kitchen', 'Bathroom', 'Dining Room', 'Office']
