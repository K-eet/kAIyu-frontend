...
function handleImageClick(image, index) {
  ...
  if (image.shouldRedirect || index === 0) {
    ...
    router.push('/ProductViewer2') // or { name: '/ProductViewer2' } if using named routes
  } else {
...
//   }
  ...
  const specificImageLinks = [
    ...
    { src: 'https://www.ikea.com/ext/ingkadam/m/4402ca03ae3a7ef8/original/PH199390.jpg?f=sg', alt: 'Modern Bedroom' },
